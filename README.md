...
| **[WebSocket API](https://oliver-zehentleitner.github.io/unicorn-binance-websocket-api/unicorn_binance_websocket_api.html#module-unicorn_binance_websocket_api.api) (order placement via WS)**   | Yes — Spot and Futures | No | Partially | Yes |
